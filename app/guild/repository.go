...
func (r *repositoryImpl) DeleteDefaultCommands(ctx context.Context, guildId string) error {
	_, err := r.db.Exec(ctx, `DELETE FROM guildcommands WHERE guildid = $1`, guildId)
